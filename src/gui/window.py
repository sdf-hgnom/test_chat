...
class EditSettings(QDialog):
    ...
    def __init__(self, what_edit: dict):
        ...
        self.edit_host: QLineEdit = QLineEdit()
        self.edit_user: QLineEdit = QLineEdit()
        self.edit_port: QLineEdit = QLineEdit()
        self.data: dict = what_edit
        self.setup_ui()
